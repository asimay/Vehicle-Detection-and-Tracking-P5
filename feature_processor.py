...
def perform_hog_feature_extraction(image_channel, orientation_bins, pixels_per_cell, cells_per_block, feature_vector=True, export_debug_image=False):
    ...
    if (export_debug_image):
        ...
        features, debug_image = hog(image_channel, orientation_bins, (pixels_per_cell, pixels_per_cell),(cells_per_block, cells_per_block),  True, True,
		feature_vector)
        ...
        #perform hog feature extraction and generate debug image 
        features = hog(image_channel, orientation_bins, (pixels_per_cell, pixels_per_cell), (cells_per_block, cells_per_block), 'L2-Hys', False, True, feature_vector)
    #return features   
    return features
